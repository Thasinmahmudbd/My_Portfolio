  ...
  <body>
    ...
    <div class="secondary_navbar_container">
        ...
        <div class="secondary_navbar">
            ...
            <p class="sub_page_name" id="U">Client Confidentiality Policies</p>
    ...
    <div class="frame_container">
        ...
        <div class="frame">
            ...
            <div class="frame_right_section">
                   ...
                   <p class="policy_design">Here are some of my <b>client confidentiality</b> policies. If you are confused about what this is and why it is necessary for you, please click <a class="article_read_more" href="666.4_learn_more.php">here</a> and learn more about it. Please read the policies for better understanding.</p>
                    ...
                    <div class="policy_design">
                        ...
                        <li class="policy"><?php echo $row['client_confidentiality_policy']; ?></li>
