...
<body>
    ...
    <form method="post" action="Dynamic/redirect.php" class="admin_login">
        ...
        <div class="fields">
            ...
            <label class="label" for="password">Insert Pin Here</label><br>
            <input class="input" type="password" name="pin" required>

        </div>

        <button class="form_btn btn_hover_coral admin_form_btn" type="submit" name="pin_confirm"><i class="fas fa-power-off log_in"></i></button>
...
if(isset($_GET['message'])){
    ...
    if($msg == "PIN Sent, This might take some time check You Email."){
